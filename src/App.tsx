...
const DESTINATIONS_DATA: Record<string, DestinationItem[]> = {
  'Oahu': [
    { id: 'o1', name: 'Hanauma Bay Nature Preserve', location: 'Oahu - City & County', county: 'Honolulu (Oahu)', category: 'State Parks', fee: 25.00, dateTime: '', website: 'https://www.honolulu.gov/parks-hbay/home.html', lat: 21.2690, lng: -157.6938, image: 'https://loveoahu.org/wp-content/uploads/snorkeling-hanauma-bay-1.jpg' },
