...
const DESTINATIONS_DATA: Record<string, DestinationItem[]> = {
  'Oahu': [
    ...
    { id: 'o2', name: 'Diamond Head State Monument', location: 'Oahu - State DLNR', county: 'Honolulu (Oahu)', category: 'State Parks', fee: 10.00, dateTime: '', website: 'https://www.shoreexcursionsgroup.com/img/tour/HWOHDIAMONDHDWF-2.jpg', lat: 21.2618, lng: -157.8045, image: 'https://images.unsplash.com/photo-1589330694653-efa637388cb2?auto=format&fit=crop&w=800&q=80' },
    { id: 'o3', name: 'Pearl Harbor Memorial', location: 'Oahu - National Park Service', county: 'Honolulu (Oahu)', category: 'National Parks', fee: 1.00, dateTime: '', website: 'https://www.nps.gov/valr/index.htm', lat: 21.3650, lng: -157.9396, image: 'https://upload.wikimedia.org/wikipedia/commons/4/47/USS_Arizona_Memorial.JPG' },
    { id: 'o4', name: 'Ahupua\'a \'O Kahana', location: 'Oahu - State DLNR', county: 'Honolulu (Oahu)', category: 'State Parks', fee: 0.00, dateTime: '', website: 'https://dlnr.hawaii.gov/dsp/parks/oahu/ahupuaa-o-kahana-state-park/', lat: 21.5560, lng: -157.8760, image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRsbKBymRMxBoqVMbkAWn-WqEfK2XLjNI5-Rw&s' },
    { id: 'o10', name: 'Bishop Museum', location: 'Honolulu - Private', county: 'Honolulu (Oahu)', category: 'Museums & Culture', fee: 25.00, dateTime: '', website: 'https://www.bishopmuseum.org/', lat: 21.3333, lng: -157.8711, image: 'https://www.craftinamerica.org/wp-content/uploads/2025/09/Bishop-Museum_Campus.jpg' }
  ],
  'Maui': [
    { id: 'm1', name: 'Haleakalā National Park', location: 'Maui - National Park Service', county: 'Maui County', category: 'National Parks', fee: 30.00, dateTime: '', website: 'https://www.nps.gov/hale/index.htm', lat: 20.7161, lng: -156.1736, image: 'https://www.mauiinn.com/wp-content/uploads/2025/02/Haleakala_National_Park.jpg' },
    { id: 'm2', name: 'Iao Valley State Monument', location: 'Maui - State DLNR', county: 'Maui County', category: 'State Parks', fee: 5.00, dateTime: '', website: 'https://dlnr.hawaii.gov/dsp/parks/maui/iao-valley-state-monument/', lat: 20.8803, lng: -156.5445, image: 'https://dlnr.hawaii.gov/dsp/files/2019/05/DJI_0005-BannerImage-scaled.jpg' },
    { id: 'm3', name: 'Wai\'anapanapa State Park', location: 'Maui - State DLNR', county: 'Maui County', category: 'State Parks', fee: 10.00, dateTime: '', website: 'https://dlnr.hawaii.gov/dsp/parks/maui/waianapanapa-state-park/', lat: 20.7844, lng: -155.9961, image: 'https://dlnr.hawaii.gov/dsp/files/2021/02/Maui-Waianapanapa-BlackSandBeach.jpg' }
  ],
  'Big Island': [
    { id: 'h1', name: 'Hawai\'i Volcanoes', location: 'Big Island - NPS', county: 'Hawaii (Big Island)', category: 'National Parks', fee: 30.00, dateTime: '', website: 'https://www.nps.gov/havo/index.htm', lat: 19.4194, lng: -155.2805, image: 'https://cdn.britannica.com/30/153430-050-967CBF40/Eruption-Kilauea-Hawaii-Volcanoes-National-Park-1983.jpg' },
    { id: 'h2', name: 'Akaka Falls State Park', location: 'Big Island - State DLNR', county: 'Hawaii (Big Island)', category: 'State Parks', fee: 5.00, dateTime: '', website: 'https://dlnr.hawaii.gov/dsp/parks/hawaii/akaka-falls-state-park/', lat: 19.8533, lng: -155.1522, image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQOu8EoRBV2JG6ekUiMhk1_nmw2APUhAq4jNw&s' },
    { id: 'h3', name: 'Pu\'uhonua o Hōnaunau', location: 'Big Island - NPS', county: 'Hawaii (Big Island)', category: 'National Parks', fee: 20.00, dateTime: '', website: 'https://www.nps.gov/puho/index.htm', lat: 19.4217, lng: -155.9125, image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSBzABaQOadJ9_NgrhTBIFHCuqFJuy1M-B-tA&s' }
  ],
  'Kauai': [
    { id: 'k1', name: 'Waimea Canyon', location: 'Kauai - State DLNR', county: 'Kauai', category: 'State Parks', fee: 10.00, dateTime: '', website: 'https://dlnr.hawaii.gov/dsp/parks/kauai/waimea-canyon-state-park/', lat: 22.0744, lng: -159.6631, image: 'https://upload.wikimedia.org/wikipedia/commons/2/27/Waimea_Canyon_mar_2010.jpg' },
    { id: 'k2', name: 'Ha\'ena State Park', location: 'Kauai - State DLNR', county: 'Kauai', category: 'State Parks', fee: 35.00, dateTime: '', website: 'https://dlnr.hawaii.gov/dsp/parks/kauai/haena-state-park/', lat: 22.2198, lng: -159.5750, image: 'https://images.exoticestates.com/files/presets/header/blog/shutterstock_122994664.jpg' }
  ]
};
