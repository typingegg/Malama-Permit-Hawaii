...
// Added high-quality Unsplash images for every location
const DESTINATIONS_DATA: Record<string, DestinationItem[]> = {
  'Oahu': [
    { id: 'o1', name: 'Hanauma Bay Nature Preserve', location: 'Oahu - City & County', county: 'Honolulu (Oahu)', category: 'State Parks', fee: 25.00, dateTime: '', website: 'https://www.honolulu.gov/parks-hbay/home.html', lat: 21.2690, lng: -157.6938, image: 'https://images.unsplash.com/photo-1542259009477-d625272157b7?auto=format&fit=crop&w=600&q=80' },
    { id: 'o2', name: 'Diamond Head State Monument', location: 'Oahu - State DLNR', county: 'Honolulu (Oahu)', category: 'State Parks', fee: 10.00, dateTime: '', website: 'https://dlnr.hawaii.gov/dsp/parks/oahu/diamond-head-state-monument/', lat: 21.2618, lng: -157.8045, image: 'https://images.unsplash.com/photo-1544644181-1484b3f8c8b4?auto=format&fit=crop&w=600&q=80' },
    { id: 'o3', name: 'Pearl Harbor Memorial', location: 'Oahu - National Park Service', county: 'Honolulu (Oahu)', category: 'National Parks', fee: 1.00, dateTime: '', website: 'https://www.nps.gov/valr/index.htm', lat: 21.3650, lng: -157.9396, image: 'https://images.unsplash.com/photo-1582967788606-a171c1080cb0?auto=format&fit=crop&w=600&q=80' },
    { id: 'o4', name: 'Ahupua\'a \'O Kahana', location: 'Oahu - State DLNR', county: 'Honolulu (Oahu)', category: 'State Parks', fee: 0.00, dateTime: '', website: 'https://dlnr.hawaii.gov/dsp/parks/oahu/ahupuaa-o-kahana-state-park/', lat: 21.5560, lng: -157.8760, image: 'https://images.unsplash.com/photo-1552089123-2d26226fc2b7?auto=format&fit=crop&w=600&q=80' },
    { id: 'o10', name: 'Bishop Museum', location: 'Honolulu - Private', county: 'Honolulu (Oahu)', category: 'Museums & Culture', fee: 25.00, dateTime: '', website: 'https://www.bishopmuseum.org/', lat: 21.3333, lng: -157.8711, image: 'https://images.unsplash.com/photo-1518998053401-b4373eb052b6?auto=format&fit=crop&w=600&q=80' }
  ],
  'Maui': [
    { id: 'm1', name: 'Haleakalā National Park', location: 'Maui - National Park Service', county: 'Maui County', category: 'National Parks', fee: 30.00, dateTime: '', website: 'https://www.nps.gov/hale/index.htm', lat: 20.7161, lng: -156.1736, image: 'https://images.unsplash.com/photo-1534008897995-27a23e859048?auto=format&fit=crop&w=600&q=80' },
    { id: 'm2', name: 'Iao Valley State Monument', location: 'Maui - State DLNR', county: 'Maui County', category: 'State Parks', fee: 5.00, dateTime: '', website: 'https://dlnr.hawaii.gov/dsp/parks/maui/iao-valley-state-monument/', lat: 20.8803, lng: -156.5445, image: 'https://images.unsplash.com/photo-1590273466170-0a86d262ffcc?auto=format&fit=crop&w=600&q=80' },
  ...
  'Big Island': [
    { id: 'h1', name: 'Hawai\'i Volcanoes', location: 'Big Island - NPS', county: 'Hawaii (Big Island)', category: 'National Parks', fee: 30.00, dateTime: '', website: 'https://www.nps.gov/havo/index.htm', lat: 19.4194, lng: -155.2805, image: 'https://images.unsplash.com/photo-1612053911574-e866a416b23b?auto=format&fit=crop&w=600&q=80' },
    { id: 'h2', name: 'Akaka Falls State Park', location: 'Big Island - State DLNR', county: 'Hawaii (Big Island)', category: 'State Parks', fee: 5.00, dateTime: '', website: 'https://dlnr.hawaii.gov/dsp/parks/hawaii/akaka-falls-state-park/', lat: 19.8533, lng: -155.1522, image: 'https://images.unsplash.com/photo-1549419141-9a7ea2867d30?auto=format&fit=crop&w=600&q=80' },
    { id: 'h3', name: 'Pu\'uhonua o Hōnaunau', location: 'Big Island - NPS', county: 'Hawaii (Big Island)', category: 'National Parks', fee: 20.00, dateTime: '', website: 'https://www.nps.gov/puho/index.htm', lat: 19.4217, lng: -155.9125, image: 'https://images.unsplash.com/photo-1563118991-f925fbaf7966?auto=format&fit=crop&w=600&q=80' }
  ],
  'Kauai': [
    { id: 'k1', name: 'Waimea Canyon', location: 'Kauai - State DLNR', county: 'Kauai', category: 'State Parks', fee: 10.00, dateTime: '', website: 'https://dlnr.hawaii.gov/dsp/parks/kauai/waimea-canyon-state-park/', lat: 22.0744, lng: -159.6631, image: 'https://images.unsplash.com/photo-1547326493-9c8eec3d7798?auto=format&fit=crop&w=600&q=80' },
    { id: 'k2', name: 'Ha\'ena State Park', location: 'Kauai - State DLNR', county: 'Kauai', category: 'State Parks', fee: 35.00, dateTime: '', website: 'https://dlnr.hawaii.gov/dsp/parks/kauai/haena-state-park/', lat: 22.2198, lng: -159.5750, image: 'https://images.unsplash.com/photo-1498804103079-a6351b050096?auto=format&fit=crop&w=600&q=80' }
  ]
};
